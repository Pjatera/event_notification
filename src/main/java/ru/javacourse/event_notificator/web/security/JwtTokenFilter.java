...
import ru.javacourse.event_notificator.service.AuthenticationService;
import ru.javacourse.event_notificator.service.JwtService;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (StringUtils.isNoneEmpty(login) && SecurityContextHolder.getContext().getAuthentication() == null) {
            if (jwtService.isValidToken(bearerToken)) {
                ...
                var authorities = jwtService.getAuthorities(bearerToken);
                var userDetails = new UserInfo(userId, authorities);
